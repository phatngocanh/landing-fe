...
const badges = [
  { icon: Truck, title: "GIAO HÀNG NHANH CHÓNG", desc: "Tiện lợi và an toàn tới tay khách hàng toàn quốc" },
  { icon: Package, title: "MIỄN PHÍ VẬN CHUYỂN", desc: "Dành cho đơn hàng giá trị từ 350.000đ trở lên" },
  { icon: ShieldCheck, title: "CHẤT LƯỢNG CAO CẤP", desc: "Sản phẩm đạt chuẩn kiểm định an toàn quốc tế" },
];
