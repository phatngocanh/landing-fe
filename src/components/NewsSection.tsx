  ...
  <section className="grid grid-cols-1 md:grid-cols-3 gap-12 bg-card p-10 md:p-14 rounded-3xl border border-border shadow-sm scroll-mt-28" id="news">
    ...
    <div className="space-y-8">
      ...
      <div className="aspect-video bg-foreground rounded-2xl overflow-hidden relative group cursor-pointer shadow-xl">
        <img className="w-full h-full object-cover opacity-60 group-hover:opacity-100 transition-opacity duration-500" src={heroBanner} alt="Video" loading="lazy" />
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-7">
        <div className="flex gap-5 group cursor-pointer items-start">
          <img className="w-16 h-16 object-cover rounded-xl shadow-sm border border-border shrink-0 group-hover:shadow-md transition-shadow" src={product1} alt="Tin tức" loading="lazy" />
        ...
        <div className="flex gap-5 group cursor-pointer items-start">
          <img className="w-16 h-16 object-cover rounded-xl shadow-sm border border-border shrink-0 group-hover:shadow-md transition-shadow" src={product2} alt="Tin tức" loading="lazy" />
          <p className="text-[14px] leading-snug font-bold text-foreground/80 group-hover:text-primary transition-colors">
