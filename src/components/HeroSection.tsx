  ...
  return (
    <section className="container mt-10" id="hero">
      <div className="relative h-[400px] md:h-[540px] rounded-2xl overflow-hidden shadow-2xl group">
        ...
        {/* Text */}
        <div
          className="absolute bottom-16 left-8 md:left-12 text-primary-foreground max-w-2xl z-[3] transition-all duration-500"
          key={current}
        ...
        <button
          onClick={prev}
          className="absolute left-4 top-1/2 -translate-y-1/2 z-[4] w-12 h-12 rounded-full bg-card/20 backdrop-blur-sm flex items-center justify-center text-primary-foreground opacity-0 group-hover:opacity-100 transition-all hover:bg-card/40 active:scale-90"
        ...
        <button
          onClick={next}
          className="absolute right-4 top-1/2 -translate-y-1/2 z-[4] w-12 h-12 rounded-full bg-card/20 backdrop-blur-sm flex items-center justify-center text-primary-foreground opacity-0 group-hover:opacity-100 transition-all hover:bg-card/40 active:scale-90"
        ...
        {/* Dots */}
        <div className="absolute bottom-8 right-12 flex gap-3 z-[4]">
          {slides.map((_, i) => (
            <button
              key={i}
              onClick={() => goTo(i)}
        ...
        {/* Progress bar */}
        <div className="absolute bottom-0 left-0 right-0 h-1 bg-primary-foreground/10 z-[4]">
          <div
